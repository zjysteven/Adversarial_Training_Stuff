...
def get_args():
    ...
    arguments.fast_advt_args(parser)
...
def main():
    ...
    save_root = os.path.join('checkpoints', arch, 'fast', 'seed_%d'%args.seed)
    ...
    # train the model
    trainer = Fast(args, model, optimizer, scheduler, writer, save_root)
    trainer.run()
