...
class CAT():
    ...
    def train(self, epoch):
        ...
        for inputs, targets, idx in batch_iter:
            ...
            adv_inputs, correct_mask = Linf_PGD_for_CAT_minhao(self.model, inputs, soft_targets, eps=eps_per_sample, return_mask=True, **self.attack_cfg)
...
def main():
    ...
    #filename = 'model'
    save_root = os.path.join('checkpoints', 'cat_minhao_my_guess', '{:s}{:d}-{:d}_seed_{:d}'.format(args.arch, args.depth, args.width, args.seed))
    if args.fixed_alpha:
