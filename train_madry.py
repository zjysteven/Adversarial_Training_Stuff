...
def main():
    ...
    filename = 'model'
    save_root = os.path.join('checkpoints', 'madry_advt', '{:s}{:d}-{:d}_seed_{:d}'.format(args.arch, args.depth, args.width, args.seed))
    ...
    # train the ensemble
    trainer = Madry_AdvT(model, optimizer, scheduler,
